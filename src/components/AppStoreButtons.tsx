...
export function AppStoreButtons({
  ...
  const defaultStyles = 'bg-black/80 border border-white/20 hover:bg-black';
  const glowStyles =
  'bg-black/60 border border-[#7CFF00]/50 shadow-[0_0_15px_rgba(124,255,0,0.3)] hover:shadow-[0_0_25px_rgba(124,255,0,0.5)]';
    ...
    <div className={`flex flex-col gap-3 ${className}`}>
      ...
      <button className={buttonClass}>
        ...
        <div className="text-left">
          <div className="text-[10px] uppercase text-gray-300 leading-none">
            Get it on
          </div>
