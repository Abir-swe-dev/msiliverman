    ...
    <div className="flex flex-col text-left max-w-2xl px-4 lg:px-0">
      ...
      <div className="mb-4 space-y-4">
        <p className="font-body text-white text-[15px] leading-snug font-medium" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.8)' }}>
          ...
          <br />
          <span className="text-[16px] font-black text-black" style={{ textShadow: 'none' }}>But new research shows significant success</span>
          <br />
          <span className="text-[16px] font-black text-black" style={{ textShadow: 'none' }}>in a alternative solution. See and preview below:</span>
        </p>
        ...
        <h2 className="font-body text-white text-[18px] md:text-[20px] font-bold leading-tight" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.8)' }}>
          ...
          <br />
          <span className="text-[24px] md:text-[28px] font-black tracking-tighter uppercase italic text-white underline decoration-2 underline-offset-4">masking,</span>{' '}
      ...
      <div className="mb-6 space-y-4">
        <div className="space-y-1">
          ...
          <p className="font-body text-white text-[13px] leading-tight font-bold opacity-95" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)' }}>
            <span className="italic underline underline-offset-2">White noise</span> is the presence of ALL audio frequencies
            <br />
        ...
        <div className="space-y-1 mt-6">
          <h3 className="font-body text-[#9DFF00] font-bold text-[17px] md:text-[19px]" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.8)' }}>
            The NEW way:{' '}
            <span className="font-normal text-[#9DFF00]">Replace the annoying ringing with</span>
          </h3>
          <p className="font-body text-[#9DFF00] text-[17px] md:text-[19px] leading-tight font-bold" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.8)' }}>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-baseline gap-1 mt-[-8px]">
          <span className="font-heading text-[42px] md:text-[48px] font-black text-[#9DFF00] lowercase tracking-tighter" style={{ textShadow: '3px 3px 6px rgba(0,0,0,0.9)' }}>
            tinnitus relief
          </span>
          <span className="font-heading text-[42px] md:text-[48px] font-medium text-[#9DFF00] lowercase tracking-tighter" style={{ textShadow: '3px 3px 6px rgba(0,0,0,0.9)' }}>
            app
          </span>
        </div>
        <p className="font-body text-white text-[20px] font-medium mt-[-4px]" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.8)' }}>
          by <span className="font-bold underline underline-offset-2">earvana.</span>
        </p>
      </div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div className="h-[2px] w-48 bg-gradient-to-r from-white/20 via-[#9DFF00] to-transparent relative">
            <div className="absolute right-0 -top-[5px] w-0 h-0 border-t-[6px] border-t-transparent border-l-[12px] border-l-[#9DFF00] border-b-[6px] border-b-transparent shadow-[2px_2px_4px_rgba(0,0,0,0.5)]"></div>
          </div>
        </div>
